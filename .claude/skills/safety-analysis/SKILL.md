...
Deploys `.engine/processes/stpa.sysml`. The engine's `stpa` skill (`.engine/skills/stpa/SKILL.md` and its SOP at
`.engine/skills/stpa/references/sop.md`) is the procedure for Steps 1–4; this skill adds the project's Steps 5–6 and the
places things live.
