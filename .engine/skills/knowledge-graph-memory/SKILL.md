...
| 4-5 identity, seed + walk | **the engine** - `keel recall` / `keel show why` over the model (D0161, D0243) | nothing |
...
| declare questions | **optional** - `.knowledge/questions` makes `keel show knowledge question-coverage` computable | declare them if you want coverage measured |
